...
def writeout(r1_header, r1_sequence, r1_space, r1_score, r2_header, r2_sequence, r2_space, r2_score, barcode):
    ...
    with open(filelist[barcode][0], "a") as o1, open(filelist[barcode][1], "a") as o2:
        o1.write(str(str(r1_header) + "\n" + str(r1_sequence) + "\n" + str(r1_space) + "\n" + str(r1_score) + "\n"))
        o2.write(str(str(r2_header) + "\n" + str(r2_sequence) + "\n" + str(r2_space) + "\n" + str(r2_score) + "\n"))
        o1.close()
        o2.close()
    return(None)
        ...
        if n_test(i1_sequence, i2_sequence) == True:
            if index_quality(i1_score, i2_score):
                if hop_test(i1_sequence, i2_sequence) == True:
                    ...
                    print("hopped")
                    print(linecount)
                    writeout(r1_header, r1_sequence, r1_space, r1_score, r2_header, r2_sequence, r2_space, r2_score, "badindex")
                else:
                    if rev_comp(i1_sequence, i2_sequence) == True:
                        ...
                        if real == "badindex":
                            ...
                            indexreads[id] +=  1
                            print(id)
                            writeout(r1_header, r1_sequence, r1_space, r1_score, r2_header, r2_sequence, r2_space, r2_score, id)
                    else:
                        mismatch += 1
                        writeout(r1_header, r1_sequence, r1_space, r1_score, r2_header, r2_sequence, r2_space, r2_score, "badindex")
            else:
